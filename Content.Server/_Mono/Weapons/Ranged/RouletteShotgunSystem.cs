...
using Content.Shared.IdentityManagement; // Exodus: respect concealed identities in public popups.
...
public sealed partial class RouletteShotgunSystem : EntitySystem
{
    ...
    private void OnInteractUsing(Entity<RouletteShotgunComponent> ent, ref InteractUsingEvent args)
    {
        ...
        _popup.PopupEntity(
            Loc.GetString("roulette-shotgun-remove-barrel-others", ("user", Identity.Name(args.User, EntityManager)), ("gun", ent.Owner)), // Exodus
            ent,
