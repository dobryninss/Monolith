...
using Content.Server.Cargo.Systems; // Exodus: reuse the completed sale event.
...
public sealed partial class CurrencyInjectionSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<EntitySoldEvent>(OnEntitiesSold); // Exodus: no currency mutation while previewing a pallet.
    }
