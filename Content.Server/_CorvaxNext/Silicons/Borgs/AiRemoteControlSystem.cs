...
public sealed partial class AiRemoteControlSystem : SharedAiRemoteControlSystem
{
    ...
    [Dependency] private PowerCellSystem _powerCell = default!; // Exodus ai-remote-power-check
    [Dependency] private IChatManager _chatManager = default!; // Exodus ai-remote-power-check
