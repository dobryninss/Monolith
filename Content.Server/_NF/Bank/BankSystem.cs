...
public sealed partial class BankSystem : SharedBankSystem
{
    ...
    public bool TryBankWithdraw(ICommonSession session, PlayerPreferences prefs, HumanoidCharacterProfile profile, int amount, [NotNullWhen(true)] out int? newBalance, bool spendLongTerm = false, bool dry = false) // Exodus: dry withdrawal
    {
