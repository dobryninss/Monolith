...
public sealed class DoAfterOverlay : Overlay
{
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        while (enumerator.MoveNext(out var uid, out _, out var comp, out var sprite, out var xform))
        {
            ...
            // Exodus: share sprite bounds between the entity's active progress bars.
            ...
            foreach (var doAfter in comp.DoAfters.Values)
            {
                ...
                {
                    if (uid != localEnt && localEnt != doAfter.Args.ShowTo) // Exodus: preserve explicitly granted visibility.
                        continue;
