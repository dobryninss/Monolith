...
using Content.Client.Lobby; // Exodus paid job balance updates.
using Content.Client.Players.PlayTimeTracking; // Exodus paid job requirement updates.
...
public sealed partial class PickerWindow : FancyWindow
{
    ...
    // Exodus-begin refresh paid job availability when profile data or requirements change.
    ...
    public new void OpenCentered()
    {
        ...
        RefreshJobRequirements(); // Exodus recheck the selected character's balance when reopening.
    }
    ...
    protected override void EnteredTree()
    {
        ...
        // Exodus-begin paid job availability.
        _preferencesManager.OnServerDataLoaded += RefreshJobRequirements;
        _jobRequirements.Updated += RefreshJobRequirements;
        // Exodus-end
    }
    ...
    // Exodus-begin paid job availability.
    private void RefreshJobRequirements()
    {
        UpdateUi(_gameTicker.StationJobInformationList);
    }
    // Exodus-end
