...
public sealed partial class NightVisionOverlay : Overlay
{
    ...
    // Exodus: minimal phosphor smoothing filter parameters.
    private static readonly float[] MinimalBlurOffsets = [0.0f, 1.0f, 2.0f];
    private static readonly float[] MinimalBlurWeights = [0.96f, 0.01f, 0.0f];
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        switch (args.Space)
        {
            ...
            case ShaderSpace:
                ...
                _nightVisionShader.SetParameter("BLUR_OFFSET", MinimalBlurOffsets);
                _nightVisionShader.SetParameter("BLUR_WEIGHT", MinimalBlurWeights);
