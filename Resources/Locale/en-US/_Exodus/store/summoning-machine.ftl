summoning-machine-ui-title = Summoning Machine
...
summoning-machine-popup-unavailable = The summoning machine is still charging or has no power.
summoning-machine-popup-unsupported = This offer cannot be summoned here.
