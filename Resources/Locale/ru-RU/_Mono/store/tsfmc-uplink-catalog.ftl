...
uplink-security-combat-pen-desc = Универсальная доза омнизина в автоматическом инъекторе.
...
uplink-security-t1-sentinel-f-voucher-desc = Небольшая карта с данными для получения корвета класса «Центинел-Ф» из резервов флагмана.
...
uplink-security-antares-voucher-desc = Небольшая карта с данными для получения эсминца класса «Антарес» из резервов флагмана.
