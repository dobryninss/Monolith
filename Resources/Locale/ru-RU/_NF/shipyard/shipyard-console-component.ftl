...
shipyard-console-docking = Шаттл { $vessel }, владелец { $owner } приобретен и доставлен.
...
shipyard-console-rename = Переименовать
shipyard-console-name-placeholder = Название
