...
shuttle-console-wrong-id = Данная ID-карта не привязана к какому-либо шаттлу.
shuttle-console-wrong-deed = Данная ID-карта не привязана к этому шаттлу.
shuttle-console-cannot-lock = У вас нет нужного доступа для блокировки шаттла.
shuttle-console-no-ship-id = Данная консоль не привязана к какому либо шаттлу.
shuttle-console-no-id-card = В вашем КПК нет ID-карты.
shuttle-console-crewed = Вы не можете одновременно использовать консоли управления шаттлом и орудиями на таком большом корабле. Лучше разделить обязанности, разве нет?
...
shuttle-console-emag-in-progress = ВНИМАНИЕ: фиксируется попытка взлома защитного контура.
