...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<string>
        GameLobbyFallbackPreset = CVarDef.Create("game.fallbackpreset", "Traitor,Extended", CVar.ARCHIVE); // Exodus: retain main-build preset fallback.
    ...
    public static readonly CVarDef<int> DynamicRolesPlayerThreshold =
         CVarDef.Create("game.dynamic_roles.player_threshold", 5, CVar.SERVERONLY | CVar.ARCHIVE); // Exodus: retain main-build role threshold.
}
