...
namespace Content.Server.Database.Migrations.Postgres
{
    ...
    [Migration("20260908103809_SS220ChatBans")]
    partial class SS220ChatBans
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Content.Server.Database._Exodus.Chat.BanChat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("ban_chat_id");
                    ...
                    b.HasIndex("BanId")
                        .HasDatabaseName("IX_ban_chat_ban_id");

                    b.HasIndex("Chat", "BanId")
                        .IsUnique();

                    b.ToTable("ban_chat", null, t =>
                        {
                            t.HasCheckConstraint("ValidChatBanChannel", "chat IN (1, 2, 3)");
                        });
                });
            ...
            modelBuilder.Entity("Content.Server.Database._Exodus.Chat.BanChat", b =>
                {
                    b.HasOne("Content.Server.Database.Ban", "Ban")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ban_chat_ban_ban_id");
